...
export function dateString(date:Date=new Date(),template:string="%%j"){
    //year : %Y 2017, %y 17
    ...
    function fillD<T>(str:T,fillStr:string,digit:number=2):string{
        var strRet:string = "" + str as string;
    ...
    Object.keys(pattern).forEach(searchStr => {
