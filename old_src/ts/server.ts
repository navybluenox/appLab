...
module app.server {
    export function sendHttpRequest(para: {method: string, url: string}): Promise<{}>{
    ...
    export function sendGASRequest(funcName:string, argu:any[] = [], userObj:Object|null = null): Promise<{}>{
